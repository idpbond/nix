...
# changes nothing about zsh. zsh stays the login shell; run `fish` to try it.
{
  programs.fish = {
    ...
    interactiveShellInit = ''
      ...
      # secrets.sops.fish is generated by `nix-secrets sync` (tracked secrets);
      # secrets.fish loads second so machine-local values can override.
      test -r $HOME/.config/fish/secrets.sops.fish && source $HOME/.config/fish/secrets.sops.fish
